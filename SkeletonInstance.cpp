...
{
	// Attach a PhysicsManager so this character can participate in collision/physics.
	...
	// Joint AABBs are updated from DefaultAnimationSM.cpp during the debug/update pass.
